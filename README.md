...
<!--
**fufu128/fufu128** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
...
```json
{
  ...
  "research": "Deep Learning for Music Source Separation",
  "interests": [
    "Competitive Programming",
    "GPU Computing & Server Admin",
    "FinTech / Personal Finance"
  ],
  "currently_building": "x-vector conditioned separation models"
}
```
